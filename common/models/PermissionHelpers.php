...
Class PermissionHelpers{
  ...
  * the last parameter . Return true or false ,so you can wrap in if statement 
  *@param mixed $userid
...
*/
  ...
  public static function requireUpdateTo($user_type_name){
...
/**
* requireMinimunStatus
*@param mixed $status_name
*/

  public static function requireMinimunStatus($status_name){
...
public static function requireMinimunRole($role_name){
